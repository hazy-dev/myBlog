	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","../../smart2/photo_uploader/img/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
	    	 ...
	    	 welBtnConfirm.attr("src","../../smart2/photo_uploader/img/btn_confirm.png");
    	 }
     }   
    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/editorFileUpload'; 	//upload URL
 		...
 		try{
	    	...
	    	for (var i = 0; i < aTemp.length ; i++){
	    		if( !!aTemp[i] && aTemp[i] != "" && aTemp[i].indexOf("=") > 0){
	    			...
	    			htTemp[aSubTemp[0]] = decodeURIComponent(aSubTemp[1]);
	    		}
	 		}
 		}catch(e){}
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/editorFileUpload',	//샘플 URL입니다.
 	        sCallback : '/callback',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
