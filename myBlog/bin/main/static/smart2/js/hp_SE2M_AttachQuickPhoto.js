...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left=400,top=200,width=403,height=359,scrollbars=yes,location=no,status=0,resizable=no";
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img name="editImage" src="{=sOriginalImageURL}" title="{=sName}" >';
